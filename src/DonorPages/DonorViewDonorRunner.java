...
public class DonorViewDonorRunner extends JPanel {
    private DefaultTableModel model;
    private JTable table;
    public DonorViewDonorRunner(){
        setLayout(null);
        ...
        centerLabel.setBounds(435,55,270,30);
        ...
        scrollPane.setBounds(320,100,450,300);

        //adding scrollPane and CenterLabel
        add(centerLabel);
        add(scrollPane);
    }
